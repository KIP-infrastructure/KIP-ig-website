# Search Parameter - write or read access sor on CarePLan - KIP Infrastructure v2.19.1
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/StructureDefinition/access-sor-code | *Version*:2.19.1 |
