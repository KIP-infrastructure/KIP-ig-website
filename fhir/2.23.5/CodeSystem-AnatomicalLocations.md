# Anatomy locations, not specified in classifcations (SKS, etc.) - KIP Infrastructure v2.23.5
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/AnatomicalLocations | *Version*:2.23.5 |
