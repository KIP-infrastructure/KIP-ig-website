# QuestionnaireResponseResponsibleOnCarePlanSP - KIP Infrastructure v2.23.5
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/SearchParameter/QuestionnaireResponseResponsibleOnCarePlan | *Version*:2.23.5 |
| Active as of 2026-07-29 | *Computable Name*:QuestionnaireResponseResponsibleOnCarePlan |
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-07-29T07:56:44+00:00",
