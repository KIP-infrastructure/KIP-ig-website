# Search Parameter - Latest for Questionnaires - KIP Infrastructure v2.23.1
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/StructureDefinition/QLatest | *Version*:2.23.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk.kip.rkkp.fhir.ig.core|current/StructureDefinition/StructureDefinition-QLatest.json)
