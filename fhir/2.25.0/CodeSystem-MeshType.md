# Mesh type - KIP Infrastructure v2.25.0
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/MeshType | *Version*:2.25.0 |
...
```json
{
  ...
  {
    "code" : "progrip_polypropylene",
    "display" : "Progrip polypropylene",
    "definition" : "Progrip polypropylene",
    "property" : [{
      "code" : "comment",
      "valueString" : "Added"
    },
