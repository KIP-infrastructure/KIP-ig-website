# Raymond-Roy occlusion Classification (RROC), incl. modified classification (MRRC) - KIP Infrastructure v2.25.0
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/RaymondRoyClassification | *Version*:2.25.0 |
...
* [Modified Raymond-Roy klassifikation (MRRC)](ValueSet-ModifiedRaymondRoyKlassification.md)
