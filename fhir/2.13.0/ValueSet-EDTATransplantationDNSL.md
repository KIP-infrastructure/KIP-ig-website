# EDTA koder Transplantation (DNSL) - KIP Infrastructure v2.13.0
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/EDTATransplantationDNSL | *Version*:2.13.0 |
    ...
    "include" : [
      {
        ...
        "concept" : [
          ...
          {
            "code" : "EDTA74",
            "display" : "EDTA 74, Grafttab, reccurent primær leverlidelse"
          },
          {
            "code" : "EDTA75",
