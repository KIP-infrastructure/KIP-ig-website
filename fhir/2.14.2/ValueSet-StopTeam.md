# Teammedlemmer på stopholdet - KIP Infrastructure v2.14.2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Teammedlemmer på stopholdet**

## ValueSet: Teammedlemmer på stopholdet (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/StopTeam | *Version*:2.14.2 |
...
```json
{
  ...
  "id" : "StopTeam",
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/StopTeam",
  "version" : "2.14.2",
  "name" : "StopTeam",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://kip.rkkp.dk/fhir/CodeSystem/StopTeam",
        "concept" : [
          {
            "code" : "anastesiLaege",
