# QuestionnaireResponseResponsibleOnCarePlan - KIP Infrastructure v2.14.2
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/SearchParameter/QuestionnaireResponseResponsibleOnCarePlan | *Version*:2.14.2 |
| Active as of 2025-12-01 | *Computable Name*:QuestionnaireResponseResponsibleOnCarePlan |
...
```json
{
  ...
  "status" : "active",
  "date" : "2025-12-01T11:28:20+00:00",
