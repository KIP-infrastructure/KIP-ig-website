# Varighed PostOP trombolyseprofylakse (DKR) - KIP Infrastructure v2.14.2
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/VarighedPostOPTrombDKR | *Version*:2.14.2 |
    ...
    "include" : [
      ...
      },
      {
        ...
        "concept" : [
          ...
          {
            "code" : "noak_b",
            "display" : "Patienten er i varig NOAK-behandling og fortsætter med vanligt præparat i fuld dosering umildbart postoperativt"
          }
        ]
      },
      {
