# Mesh placering (DHDB) - KIP Infrastructure v2.14.2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Mesh placering (DHDB)**

## ValueSet: Mesh placering (DHDB) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/MeshPlaceringDHDB | *Version*:2.14.2 |
| Active as of 2022-07-20 | *Computable Name*:MeshPlaceringDHDB |
