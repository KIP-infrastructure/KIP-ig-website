# Sygdomslokalisation er kun ekstranodalt, mænd (LYFO) version 2 - KIP Infrastructure v2.17.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Sygdomslokalisation er kun ekstranodalt, mænd (LYFO) version 2**

## ValueSet: Sygdomslokalisation er kun ekstranodalt, mænd (LYFO) version 2 (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/locationExtranodalMale-V2 | *Version*:2.17.1 |
| Active as of 2025-01-09 | *Computable Name*:LocationExtranodalMale_V2 |
...
```json
{
  ...
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/locationExtranodalMale-V2",
  "version" : "2.17.1",
  "name" : "LocationExtranodalMale_V2",
