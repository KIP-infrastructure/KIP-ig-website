# Preoperativ templating - KIP Infrastructure v2.17.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Preoperativ templating**

## ValueSet: Preoperativ templating (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/PreoperativTemplating | *Version*:2.17.1 |
| Active as of 2024-01-03 | *Computable Name*:PreoperativTemplating |

 
Preoperativ templating (DHR) 
...
```json
{
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://kip.rkkp.dk/fhir/CodeSystem/PreoperativTemplating",
        "concept" : [
          {
            "code" : "digital_both",
