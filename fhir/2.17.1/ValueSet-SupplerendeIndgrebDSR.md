# Supplerende indgreb (DSR) - KIP Infrastructure v2.17.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Supplerende indgreb (DSR)**

## ValueSet: Supplerende indgreb (DSR) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SupplerendeIndgrebDSR | *Version*:2.17.1 |
| Active as of 2022-07-04 | *Computable Name*:SupplerendeIndgrebDSR |
    ...
    "include" : [
      {
        ...
        "concept" : [
          ...
          {
            "code" : "tenotomy",
            "display" : "Bicepstenotomi"
          },
          {
            "code" : "tenodesis",
            "display" : "Biceps tenodese"
          }
        ]
      },
      {
