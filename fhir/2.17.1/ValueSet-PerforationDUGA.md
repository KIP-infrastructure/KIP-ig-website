# Perforation (DUGA) - KIP Infrastructure v2.17.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perforation (DUGA)**

## ValueSet: Perforation (DUGA) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/PerforationDUGA | *Version*:2.17.1 |
| Active as of 2024-02-14 | *Computable Name*:PerforationDUGA |

 
Procedurekode - Perforation (DUGA) 
...
```json
{
  ...
  "id" : "PerforationDUGA",
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/PerforationDUGA",
  "version" : "2.17.1",
  "name" : "PerforationDUGA",
