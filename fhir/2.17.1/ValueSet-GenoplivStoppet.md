# Genoplivning indstillet - årsag - KIP Infrastructure v2.17.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Genoplivning indstillet - årsag**

## ValueSet: Genoplivning indstillet - årsag (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/GenoplivStoppet | *Version*:2.17.1 |
...
```json
{
  ...
  "id" : "GenoplivStoppet",
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/GenoplivStoppet",
  "version" : "2.17.1",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://kip.rkkp.dk/fhir/CodeSystem/GenoplivStoppet",
        "concept" : [
          {
            "code" : "spontan_kreds",
