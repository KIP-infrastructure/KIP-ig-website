# Search Parameter - SOR-code author on a CarePlan - KIP Infrastructure v2.23.0
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/StructureDefinition/SorAuthor | *Version*:2.23.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk.kip.rkkp.fhir.ig.core|current/StructureDefinition/StructureDefinition-SorAuthor.json)
