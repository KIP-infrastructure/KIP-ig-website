# Ledbåndsrekonstruktioner (DKRR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Ledbåndsrekonstruktioner (DKRR)**

## ValueSet: Ledbåndsrekonstruktioner (DKRR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/LedbaandsrekonstruktionDKRR | *Version*:2.26.0 |
