# Paragraffer (RETSPSYK) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paragraffer (RETSPSYK)**

## ValueSet: Paragraffer (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/ParagrafferRETSPSYK | *Version*:2.26.0 |
