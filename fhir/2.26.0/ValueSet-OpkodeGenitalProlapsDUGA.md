# Operationskode - Genital prolaps (DUGA) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Operationskode - Genital prolaps (DUGA)**

## ValueSet: Operationskode - Genital prolaps (DUGA) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/OpkodeGenitalProlapsDUGA | *Version*:2.26.0 |
