# Cement - femur, tibia og patella (DKR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Cement - femur, tibia og patella (DKR)**

## ValueSet: Cement - femur, tibia og patella (DKR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/CementFemurTibiaPatellaDKR | *Version*:2.26.0 |
