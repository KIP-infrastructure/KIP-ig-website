# Fiksation, Femur (DKRR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Fiksation, Femur (DKRR)**

## ValueSet: Fiksation, Femur (DKRR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/FiksationFemurDKRR | *Version*:2.26.0 |
