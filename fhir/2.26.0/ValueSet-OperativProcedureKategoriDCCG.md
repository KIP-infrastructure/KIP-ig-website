# Operativ Procedurekategori (DCCG) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Operativ Procedurekategori (DCCG)**

## ValueSet: Operativ Procedurekategori (DCCG) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/OperativProcedureKategoriDCCG | *Version*:2.26.0 |
