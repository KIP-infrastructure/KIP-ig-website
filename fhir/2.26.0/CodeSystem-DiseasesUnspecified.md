# Diseases - Unspecified without a code - KIP Infrastructure v2.26.0
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/DiseasesUnspecified | *Version*:2.26.0 |
...
* [Diagnose DMPN](ValueSet-DiagnoseDMPN.md)
* [Diagnose DMPN opfølgning](ValueSet-DiagnoseDMPNopfoelgning.md)
* [Diagnosegruppe (HAEMA)](ValueSet-DiagnosegruppeHAEMA.md)
...
* [Patobank SNOMED DMPN Diagnose](ValueSet-PatobankSNOMEDDMPNDiagnose.md)
* [PatobankSNOMED - Diagnoser (LYFO) (retired)](ValueSet-PatobankSNOMEDDiagnoserLYFO.md)
* [PatobankSNOMED - Diagnoser (LYFO)](ValueSet-PatobankSNOMEDDiagnoserLYFO2026.md)
* [Plasma Analyse - kræft diagnose](ValueSet-PlasmaDiagnose.md)
* [Plasma Analyse - kræft diagnose 202412](ValueSet-PlasmaDiagnose202412.md)
* [Registrering - Eksklusionsårsag (HAEMA)](ValueSet-RegistreringEksklusionHAEMA.md)
* [Risikofaktorer DMPN](ValueSet-RisikofaktorerDMPN.md)
* [Stomi type (DHDB)](ValueSet-StomiTypeDHDB.md)
...
```json
{
  ...
  },
  {
    ...
    {
      "code" : "effectiveDate",
      "valueDateTime" : "2026-03-10T00:00:00+01:00"
    },
    {
      "code" : "status",
      "valueCode" : "retired"
