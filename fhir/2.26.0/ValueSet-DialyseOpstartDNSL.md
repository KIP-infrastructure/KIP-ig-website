# Dialyseopstart (DNSL) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Dialyseopstart (DNSL)**

## ValueSet: Dialyseopstart (DNSL) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/DialyseOpstartDNSL | *Version*:2.26.0 |
