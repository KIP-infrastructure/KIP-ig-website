# M component (Myeloma protein) type - KIP Infrastructure v2.26.0
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/MComponentType | *Version*:2.26.0 |
...
* [Plasma M komponent (Myeloma protein) type](ValueSet-MComponentTypeDAMYDA.md)
* [M komponent (Myeloma protein) type](ValueSet-MComponentTypeLyfo.md)
* [U-M komponent type](ValueSet-UMComponentTypeDAMYDA.md)
