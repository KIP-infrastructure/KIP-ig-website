# Kirurgisk adgang (DSR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Kirurgisk adgang (DSR)**

## ValueSet: Kirurgisk adgang (DSR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KirurgiskAdgangDSR | *Version*:2.26.0 |
