# Mesh fiksering (DHDB) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Mesh fiksering (DHDB)**

## ValueSet: Mesh fiksering (DHDB) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/MeshFikseringDHDB | *Version*:2.26.0 |
