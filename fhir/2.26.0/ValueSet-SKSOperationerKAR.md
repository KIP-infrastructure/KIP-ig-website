# SKS: Operationer (KAR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SKS: Operationer (KAR)**

## ValueSet: SKS: Operationer (KAR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SKSOperationerKAR | *Version*:2.26.0 |
