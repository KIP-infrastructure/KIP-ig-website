# Kognitiv påvirkning (DANDEM) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Kognitiv påvirkning (DANDEM)**

## ValueSet: Kognitiv påvirkning (DANDEM) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KognitivPaavirkningDANDEM | *Version*:2.26.0 |
