# SOR: Overflytning Sjælland (RETSPSYK) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SOR: Overflytning Sjælland (RETSPSYK)**

## ValueSet: SOR: Overflytning Sjælland (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SOROverflytningRETSPSYKSJ | *Version*:2.26.0 |
