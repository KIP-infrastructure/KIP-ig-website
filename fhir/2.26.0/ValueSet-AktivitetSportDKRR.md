# Aktivitet: Sport (DKRR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Aktivitet: Sport (DKRR)**

## ValueSet: Aktivitet: Sport (DKRR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/AktivitetSportDKRR | *Version*:2.26.0 |
