# SOR: Afdelinger (HÆMA) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SOR: Afdelinger (HÆMA)**

## ValueSet: SOR: Afdelinger (HÆMA) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SORAfdelingerHaema | *Version*:2.26.0 |
