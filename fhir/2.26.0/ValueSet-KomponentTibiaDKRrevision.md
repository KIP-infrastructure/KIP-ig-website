# Komponent - tibia (DKR) revision - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komponent - tibia (DKR) revision**

## ValueSet: Komponent - tibia (DKR) revision 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomponentTibiaDKRrevision | *Version*:2.26.0 |
