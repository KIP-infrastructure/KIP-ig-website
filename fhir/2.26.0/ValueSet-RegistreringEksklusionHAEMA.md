# Registrering - Eksklusionsårsag (HAEMA) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Registrering - Eksklusionsårsag (HAEMA)**

## ValueSet: Registrering - Eksklusionsårsag (HAEMA) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/RegistreringEksklusionHAEMA | *Version*:2.26.0 |
