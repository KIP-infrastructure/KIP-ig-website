# Sygdom; medicinsk behandlet (DHDB) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Sygdom; medicinsk behandlet (DHDB)**

## ValueSet: Sygdom; medicinsk behandlet (DHDB) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SygdomMedicinskBehandletDHDB | *Version*:2.26.0 |
