# POP-Q undersøgelse Kompartment (DUGA) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **POP-Q undersøgelse Kompartment (DUGA)**

## ValueSet: POP-Q undersøgelse Kompartment (DUGA) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/POPQKompartmentDUGA | *Version*:2.26.0 |
