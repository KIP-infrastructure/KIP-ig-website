# Årsag til anden/aflastende procedure colorectal cancer - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Årsag til anden/aflastende procedure colorectal cancer**

## ValueSet: Årsag til anden/aflastende procedure colorectal cancer 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/AarsagTilProcedureDCCG | *Version*:2.26.0 |
