# SOR: Overflytning Nordjylland (RETSPSYK) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SOR: Overflytning Nordjylland (RETSPSYK)**

## ValueSet: SOR: Overflytning Nordjylland (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SOROverflytningRETSPSYKNJ | *Version*:2.26.0 |
