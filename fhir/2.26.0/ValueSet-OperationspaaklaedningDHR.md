# Operationspåklædning [DHR] - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Operationspåklædning [DHR]**

## ValueSet: Operationspåklædning [DHR] 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/OperationspaaklaedningDHR | *Version*:2.26.0 |
