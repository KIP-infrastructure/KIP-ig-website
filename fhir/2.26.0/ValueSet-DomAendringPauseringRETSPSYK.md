# Dom - Ændring/pausering (RETSPSYK) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Dom - Ændring/pausering (RETSPSYK)**

## ValueSet: Dom - Ændring/pausering (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/DomAendringPauseringRETSPSYK | *Version*:2.26.0 |
