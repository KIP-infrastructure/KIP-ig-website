# Årsag til ændret behandlingsplan DCCG - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Årsag til ændret behandlingsplan DCCG**

## ValueSet: Årsag til ændret behandlingsplan DCCG 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/BehandlinsplanAendretAarsagDCCG | *Version*:2.26.0 |
