# Peritonealdefekt lukning (DHDB) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Peritonealdefekt lukning (DHDB)**

## ValueSet: Peritonealdefekt lukning (DHDB) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/PeritonealdefektLukningDHDB | *Version*:2.26.0 |
