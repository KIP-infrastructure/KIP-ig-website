# Behandlinger foretaget i forbindelse med MDS (MDS) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Behandlinger foretaget i forbindelse med MDS (MDS)**

## ValueSet: Behandlinger foretaget i forbindelse med MDS (MDS) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/BehandlingMDS | *Version*:2.26.0 |
