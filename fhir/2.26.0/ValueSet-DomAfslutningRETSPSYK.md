# Dom - Afslutning (RETSPSYK) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Dom - Afslutning (RETSPSYK)**

## ValueSet: Dom - Afslutning (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/DomAfslutningRETSPSYK | *Version*:2.26.0 |
