# Kontakt til patienten - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Kontakt til patienten**

## ValueSet: Kontakt til patienten 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KontaktPatient | *Version*:2.26.0 |
