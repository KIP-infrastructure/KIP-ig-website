# Hvorfor er patienten ikke involveret - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Hvorfor er patienten ikke involveret**

## ValueSet: Hvorfor er patienten ikke involveret 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/ClinicalProtocolNotParticipated | *Version*:2.26.0 |
