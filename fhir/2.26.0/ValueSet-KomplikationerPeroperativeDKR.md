# Komplikationer, peroperative (DKR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komplikationer, peroperative (DKR)**

## ValueSet: Komplikationer, peroperative (DKR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomplikationerPeroperativeDKR | *Version*:2.26.0 |
