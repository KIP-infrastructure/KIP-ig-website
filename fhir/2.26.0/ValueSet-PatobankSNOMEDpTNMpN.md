# Patobank SNOMED: pTNM klassifikation, pN - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Patobank SNOMED: pTNM klassifikation, pN**

## ValueSet: Patobank SNOMED: pTNM klassifikation, pN 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/PatobankSNOMEDpTNMpN | *Version*:2.26.0 |
