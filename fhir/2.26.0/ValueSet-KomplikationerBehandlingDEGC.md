# Komplikationer, behandling (DEGC) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komplikationer, behandling (DEGC)**

## ValueSet: Komplikationer, behandling (DEGC) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomplikationerBehandlingDEGC | *Version*:2.26.0 |
