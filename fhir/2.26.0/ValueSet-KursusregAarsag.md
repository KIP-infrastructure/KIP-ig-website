# Kursusregistrering - årsag - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Kursusregistrering - årsag**

## ValueSet: Kursusregistrering - årsag 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KursusregAarsag | *Version*:2.26.0 |
