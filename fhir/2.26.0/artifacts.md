# Artifacts Summary - KIP Infrastructure v2.26.0
...
| | |
| :--- | :--- |
| [CarePlanReadOrWriteAccessSP](SearchParameter-CarePlanReadOrWriteAccessSP.md) | Search a CarePlan for readAccess or writeAccess SOR code |
...
| [QuestionnaireResponseResponsibleOnCarePlanSP](SearchParameter-QuestionnaireResponseResponsibleOnCarePlanSP.md) | Search a CarePlan for responsible SOR code on a QuestionnaireResponse |
...
| [ValueSetLatest](SearchParameter-ValueSetLatest.md) | Search ValueSet for 'latest' extension |
| [semver](SearchParameter-semver.md) | Composite search parameter representing semantic version (major.minor.patch) extracted from version field. |
| [semver-major](SearchParameter-semver-major.md) | Major version number extracted from version field. |
| [semver-minor](SearchParameter-semver-minor.md) | Minor version number extracted from version field. |
| [semver-patch](SearchParameter-semver-patch.md) | Patch version number extracted from version field. |
...
| | |
| :--- | :--- |
| [Display Order for PlanDefinition Action](StructureDefinition-plan-definition-action-display-order.md) | Specifies the desired display order of a PlanDefinition action (e.g. Questionnaire references). Lower values are displayed first. |
...
| [Search Parameter - Latest for ValueSets](StructureDefinition-VSLatest.md) | Limit response of ValueSets to match given Latest. |
...
| [Anæstesi komplikationer 2026](ValueSet-ComplicationAN2026.md) | Anæstesi komplikationer |
| [Anæstesiform (DUGA)](ValueSet-AnaestesiDUGA.md) | Anæstesiform (DUGA) |
| [Anæstesiydelse](ValueSet-AnasthesiaService.md) | Anæstesiydelse |
| [Anæstesiydelse 2026](ValueSet-AnasthesiaService2026.md) | Anæstesiydelse |
| [Anæstesiydelse DAD](ValueSet-AnasthesiaServiceDAD.md) | Anæstesiydelse |
...
| [Behandlingsplan (2025)](ValueSet-TreatmentRegimen-2025.md) | Behandlingsplan som beskriver specifikke codsering og planlægningen af behandling |
...
| [Dele følelser](ValueSet-DeleFoelelser.md) | Dele følelser |
...
| [Foerste kontakt sted 2026](ValueSet-KontaktSted2026.md) | Sted for første kontakt 2026 |
...
| [Grundlidelse [DHR] 2026-07](ValueSet-GrundlidelseDHR-2026-07.md) | Grundlidelse [DHR] |
...
| [Implantat - materiale (keramik, metal, andet) 2026-07](ValueSet-ImplantatMateriale-KeramikMetalAndet-2026-07.md) | Implantat - materiale (keramik, metal, andet) |
...
| [Laryngoskopigrad 2026](ValueSet-LaryngoskopiDegree2026.md) | Bedst opnåede laryngoskopigrad ved direkte laryngoskopi efter Cormack & Lehane |
...
| [Liqour drænage](ValueSet-LiqourDraenage.md) | Liqour drænage |
...
| [Lokal blødning Trombolyse](ValueSet-LokalBloedningTrombolyse.md) | Lokal blødning fundet i forbindelse med billeddiagnostisk undersøgelse (DAP) |
...
| [Lokation for tromber, fundet vha. DSA 2026](ValueSet-DSAFundLokation2026.md) | Lokation for tromber, fundet vha. digital subtraktionsangiografi (DSA). |
...
| [Luftvejshåndtering 2026](ValueSet-LuftvejsHaandtering2026.md) | Anvendte indgreb til luftvejsunderstøttelse |
| [Luftvejshåndtering sidste forsøg](ValueSet-LuftvejsHaandteringsidsteforsoeg.md) | Luftvejshåndtering sidste forsøg |
| [Luftvejsplan](ValueSet-Luftvejsplan.md) | Mulige planlagte indgreb til luftvejsunderstøttelse |
| [Luftvejsplan 2026](ValueSet-Luftvejsplan2026.md) | Mulige planlagte indgreb til luftvejsunderstøttelse |
...
| [PatobankSNOMED - Diagnoser (LYFO)](ValueSet-PatobankSNOMEDDiagnoserLYFO2026.md) | PatobankSNOMED - Diagnoser (LYFO) |
| [PatobankSNOMED - Diagnoser (LYFO) (retired)](ValueSet-PatobankSNOMEDDiagnoserLYFO.md) | PatobankSNOMED - Diagnoser (LYFO) |
...
| [Postoperativ komplikationer 2026](ValueSet-ComplicationPO2026.md) | Postoperative komplikationer |
...
| [Robot (DKR)-2026-07](ValueSet-Robot-DKR-2026-07.md) | Robottyper til robot assisteret kirurgi (DKR) |
...
| [Sutur materiale, ingivinalhernie (DHDB)](ValueSet-SuturMaterialeIngivinalhernieDHDB.md) | Sutur materiale, ingivinalhernie (DHDB) |
...
| [Taget hånd om problemer](ValueSet-HandProblemer.md) | Taget hånd om problemer, PRO-PAL-skema 1 |
...
| [TilsynAfdeling - DPD](ValueSet-TilsynAfdeling.md) | TilsynAfdeling - DPD |
...
| [Ventral hernie type (DHDB) 2026](ValueSet-VentralHernieTypeDHDB2026.md) | Ventral hernie type (DHDB) |
...
| [Liquor drain](CodeSystem-LiquorDrain.md) | Liqour drænage |
...
| [Taget hånd om problemer](CodeSystem-HaandProblemer.md) | Taget hånd om problemer, PRO-PAL-skema 1 |
...
| [TilsynAfdeling - DPD](CodeSystem-TilsynAfdeling.md) | TilsynAfdeling - DPD |
