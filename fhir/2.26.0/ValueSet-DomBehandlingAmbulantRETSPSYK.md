# Dom - Behandling, ambulant (RETSPSYK) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Dom - Behandling, ambulant (RETSPSYK)**

## ValueSet: Dom - Behandling, ambulant (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/DomBehandlingAmbulantRETSPSYK | *Version*:2.26.0 |
