# Mors Diagnosekode - Infektioner (DNSL) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Mors Diagnosekode - Infektioner (DNSL)**

## ValueSet: Mors Diagnosekode - Infektioner (DNSL) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/MorsDiagnoseInfektionerDNSL | *Version*:2.26.0 |
