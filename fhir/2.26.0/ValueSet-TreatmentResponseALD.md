# Patient respons på behandling (ALD) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Patient respons på behandling (ALD)**

## ValueSet: Patient respons på behandling (ALD) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/TreatmentResponseALD | *Version*:2.26.0 |
