# Sutur monofilament type, ventralhernie (DHDB) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Sutur monofilament type, ventralhernie (DHDB)**

## ValueSet: Sutur monofilament type, ventralhernie (DHDB) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SuturMonofilamentTypeVentralhernieDHDB | *Version*:2.26.0 |
