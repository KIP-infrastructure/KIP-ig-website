# Liner komponent med Post (DKR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Liner komponent med Post (DKR)**

## ValueSet: Liner komponent med Post (DKR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/LinerMedPostDKR | *Version*:2.26.0 |
