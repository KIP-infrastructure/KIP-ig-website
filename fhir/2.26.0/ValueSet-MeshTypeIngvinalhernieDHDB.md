# Mesh type - Ingvinalhernie (DHDB) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Mesh type - Ingvinalhernie (DHDB)**

## ValueSet: Mesh type - Ingvinalhernie (DHDB) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/MeshTypeIngvinalhernieDHDB | *Version*:2.26.0 |
