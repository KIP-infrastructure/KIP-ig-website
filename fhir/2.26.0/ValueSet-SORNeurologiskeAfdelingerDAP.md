# SOR: Neurologiske afdelinger (DAP) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SOR: Neurologiske afdelinger (DAP)**

## ValueSet: SOR: Neurologiske afdelinger (DAP) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SORNeurologiskeAfdelingerDAP | *Version*:2.26.0 |
