# ICD 10 non-cancer koder til DPD - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ICD 10 non-cancer koder til DPD**

## ValueSet: ICD 10 non-cancer koder til DPD 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/IDC10DPDNonCancer | *Version*:2.26.0 |
