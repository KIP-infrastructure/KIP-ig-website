# EDTA koder Peritonedialyse (DNSL) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EDTA koder Peritonedialyse (DNSL)**

## ValueSet: EDTA koder Peritonedialyse (DNSL) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/EDTAPeritonedialyseDNSL | *Version*:2.26.0 |
