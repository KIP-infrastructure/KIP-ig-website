# Reoperation årsager (DKRR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Reoperation årsager (DKRR)**

## ValueSet: Reoperation årsager (DKRR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/ReoperationAarsagDKRR | *Version*:2.26.0 |
