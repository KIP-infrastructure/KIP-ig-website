# Vancouver klassifikation (DHR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Vancouver klassifikation (DHR)**

## ValueSet: Vancouver klassifikation (DHR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/VancouverKlassifikationDHR | *Version*:2.26.0 |
