# Operation Ikke Gennemført (DCCG) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Operation Ikke Gennemført (DCCG)**

## ValueSet: Operation Ikke Gennemført (DCCG) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/OperationIkkeGennemfortDCCG | *Version*:2.26.0 |
