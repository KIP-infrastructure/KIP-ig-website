# Femur knogletab klassifikation (DHR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Femur knogletab klassifikation (DHR)**

## ValueSet: Femur knogletab klassifikation (DHR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/FemurKnogletabKlassifikationDHR | *Version*:2.26.0 |
