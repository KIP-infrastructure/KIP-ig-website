# Procedurer, andre (DKRR) - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Procedurer, andre (DKRR)**

## ValueSet: Procedurer, andre (DKRR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/ProcedurerAndreDKRR | *Version*:2.26.0 |
