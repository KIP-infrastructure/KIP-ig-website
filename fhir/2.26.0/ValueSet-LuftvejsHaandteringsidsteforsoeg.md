# Luftvejshåndtering sidste forsøg - KIP Infrastructure v2.26.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Luftvejshåndtering sidste forsøg**

## ValueSet: Luftvejshåndtering sidste forsøg 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/LuftvejsHaandteringsidsteforsoeg | *Version*:2.26.0 |
