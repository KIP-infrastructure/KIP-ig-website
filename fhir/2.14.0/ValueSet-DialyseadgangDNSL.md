# Dialyseadgang ved første dialyse (DNSL) - KIP Infrastructure v2.14.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Dialyseadgang ved første dialyse (DNSL)**

## ValueSet: Dialyseadgang ved første dialyse (DNSL) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/DialyseadgangDNSL | *Version*:2.14.0 |
| Active as of 2024-01-10 | *Computable Name*:DialyseadgangDNSL |

 
Dialyseadgang ved første dialyse 
