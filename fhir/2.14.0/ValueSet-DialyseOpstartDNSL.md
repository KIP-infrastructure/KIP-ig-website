# Dialyseopstart (DNSL) - KIP Infrastructure v2.14.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Dialyseopstart (DNSL)**

## ValueSet: Dialyseopstart (DNSL) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/DialyseOpstartDNSL | *Version*:2.14.0 |
| Active as of 2024-01-10 | *Computable Name*:DialyseOpstartDNSL |

 
Dialyseopstart ved første dialyse (DNSL) 
