# Banff Classifikation - KIP Infrastructure v2.14.1
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/BANFF | *Version*:2.14.1 |
...
This code system `https://kip.rkkp.dk/fhir/CodeSystem/BANFF` provides **a fragment** that includes following codes:
