# Den Danske SNOMED for Patologi - KIP Infrastructure v2.14.1
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/PatobankSNOMED | *Version*:2.14.1 |
...
This case-sensitive code system `https://kip.rkkp.dk/fhir/CodeSystem/PatobankSNOMED` provides **a fragment** that includes following codes:
