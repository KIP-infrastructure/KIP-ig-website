# Search Parameter - write or read access sor on CarePLan - KIP Infrastructure v2.15.0
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/StructureDefinition/access-sor-code | *Version*:2.15.0 |
