# Implantattype (DUGA) - KIP Infrastructure v2.15.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Implantattype (DUGA)**

## ValueSet: Implantattype (DUGA) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/ImplantattypeDUGA | *Version*:2.15.0 |
...
```json
{
  ...
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/ImplantattypeDUGA",
  "version" : "2.15.0",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://kip.rkkp.dk/fhir/CodeSystem/ImplantattypeDUGA",
        "concept" : [
          {
            "code" : "1",
