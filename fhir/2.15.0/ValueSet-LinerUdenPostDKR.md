# Liner komponent uden Post (DKR) - KIP Infrastructure v2.15.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Liner komponent uden Post (DKR)**

## ValueSet: Liner komponent uden Post (DKR) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/LinerUdenPostDKR | *Version*:2.15.0 |
| Active as of 2023-12-18 | *Computable Name*:LinerUdenPostDKR |
...
```json
{
  ...
  "id" : "LinerUdenPostDKR",
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/LinerUdenPostDKR",
  "version" : "2.15.0",
  "name" : "LinerUdenPostDKR",
