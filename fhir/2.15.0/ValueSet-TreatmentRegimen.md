# Behandlingsplan - KIP Infrastructure v2.15.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Behandlingsplan**

## ValueSet: Behandlingsplan (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/TreatmentRegimen | *Version*:2.15.0 |
| Active as of 2022-07-13 | *Computable Name*:TreatmentRegimen |
...
```json
{
  ...
  "id" : "TreatmentRegimen",
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/TreatmentRegimen",
  "version" : "2.15.0",
