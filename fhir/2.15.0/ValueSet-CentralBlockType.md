# Typer af central blokade - KIP Infrastructure v2.15.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Typer af central blokade**

## ValueSet: Typer af central blokade (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/CentralBlockType | *Version*:2.15.0 |
| Active as of 2022-06-09 | *Computable Name*:CentralBlockType |
...
```json
{
  ...
  "id" : "CentralBlockType",
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/CentralBlockType",
  "version" : "2.15.0",
  "name" : "CentralBlockType",
