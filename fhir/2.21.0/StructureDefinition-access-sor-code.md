# Search Parameter - write or read access sor on CarePLan - KIP Infrastructure v2.21.0
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/StructureDefinition/access-sor-code | *Version*:2.21.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dk.kip.rkkp.fhir.ig.core|current/StructureDefinition/StructureDefinition-access-sor-code.json)
