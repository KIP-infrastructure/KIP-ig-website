# Komponent - femur (DKR) revision - KIP Infrastructure v2.13.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komponent - femur (DKR) revision**

## ValueSet: Komponent - femur (DKR) revision (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomponentFemurDKRrevision | *Version*:2.13.0 |
| Active as of 2025-03-04 | *Computable Name*:KomponentFemurDKRrevision |
...
```json
{
  ...
  "id" : "KomponentFemurDKRrevision",
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/KomponentFemurDKRrevision",
  "version" : "2.13.0",
  "name" : "KomponentFemurDKRrevision",
