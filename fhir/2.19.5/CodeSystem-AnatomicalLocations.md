# Anatomy locations, not specified in classifcations (SKS, etc.) - KIP Infrastructure v2.19.5
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/AnatomicalLocations | *Version*:2.19.5 |
...
* [Anatomisk lokation 4](ValueSet-AnatomiskLokation4.md)
* [Placering af brusklæsioner (DKRR)](ValueSet-BrusklaesionPlaceringDKRR.md)
