# Frekvens - KIP Infrastructure v2.19.5
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/Frekvens | *Version*:2.19.5 |
| Active as of 2026-06-24 | *Computable Name*:Frekvens |
...
* [Dele følelser](ValueSet-DeleFoelelser.md)
* [Frekvens læk (DUGA)](ValueSet-FrekvensLaekDUGA.md)
* [Frekvens Nedsynkning (DUGA)](ValueSet-FrekvensNedsynkningDUGA.md)
...
```json
{
  ...
  {
    "code" : "forDetMeste",
    "display" : "For det meste",
    "definition" : "For det meste",
    "property" : [{
      "code" : "comment",
      "valueString" : "Added"
    },
