# Artrose Placering (DKR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Artrose Placering (DKR)**

## ValueSet: Artrose Placering (DKR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/ArtrosePlaceringDKR | *Version*:1.25.1 |
