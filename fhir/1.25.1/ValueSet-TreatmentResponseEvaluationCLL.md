# Treatment_Response_Evaluation_CLL - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Treatment_Response_Evaluation_CLL**

## ValueSet: Treatment_Response_Evaluation_CLL 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/TreatmentResponseEvaluationCLL | *Version*:1.25.1 |
