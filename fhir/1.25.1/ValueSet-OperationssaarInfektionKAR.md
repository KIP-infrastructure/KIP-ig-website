# Operationssår infektion (KAR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Operationssår infektion (KAR)**

## ValueSet: Operationssår infektion (KAR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/OperationssaarInfektionKAR | *Version*:1.25.1 |
