# Placering af brusklæsioner (DKRR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Placering af brusklæsioner (DKRR)**

## ValueSet: Placering af brusklæsioner (DKRR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/BrusklaesionPlaceringDKRR | *Version*:1.25.1 |
