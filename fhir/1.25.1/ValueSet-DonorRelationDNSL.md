# Relationen til donor (DNSL) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Relationen til donor (DNSL)**

## ValueSet: Relationen til donor (DNSL) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/DonorRelationDNSL | *Version*:1.25.1 |
