# Mesh type - Ventralhernie (DHDB) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Mesh type - Ventralhernie (DHDB)**

## ValueSet: Mesh type - Ventralhernie (DHDB) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/MeshTypeVentralhernieDHDB | *Version*:1.25.1 |
