# Komplikationer pga. 'Andre' - Procedurekoder (DUGA) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komplikationer pga. 'Andre' - Procedurekoder (DUGA)**

## ValueSet: Komplikationer pga. 'Andre' - Procedurekoder (DUGA) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomplAndreProcDUGA | *Version*:1.25.1 |
