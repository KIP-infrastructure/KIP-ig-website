# Operation - aktuel (DKRR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Operation - aktuel (DKRR)**

## ValueSet: Operation - aktuel (DKRR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/OperationerAktuelDKRR | *Version*:1.25.1 |
