# Knæ løshed (posterolateral) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Knæ løshed (posterolateral)**

## ValueSet: Knæ løshed (posterolateral) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KnaeLoeshedPosterolateral | *Version*:1.25.1 |
