# Revision, årsag (DKRR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Revision, årsag (DKRR)**

## ValueSet: Revision, årsag (DKRR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/RevisionAarsagDKRR | *Version*:1.25.1 |
