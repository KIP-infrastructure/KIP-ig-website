# MDT-beslutning ikke fulgt; årsag - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MDT-beslutning ikke fulgt; årsag**

## ValueSet: MDT-beslutning ikke fulgt; årsag 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/MDTIkkeFulgt | *Version*:1.25.1 |
