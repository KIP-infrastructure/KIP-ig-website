# Plasma M komponent (Myeloma protein) type - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Plasma M komponent (Myeloma protein) type**

## ValueSet: Plasma M komponent (Myeloma protein) type 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/MComponentTypeDAMYDA | *Version*:1.25.1 |
