# Komponent - acetabulum (DHR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komponent - acetabulum (DHR)**

## ValueSet: Komponent - acetabulum (DHR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomponentAcetabulumDHR | *Version*:1.25.1 |
