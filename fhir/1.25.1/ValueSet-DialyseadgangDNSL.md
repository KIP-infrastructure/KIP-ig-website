# Dialyseadgang ved første dialyse (DNSL) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Dialyseadgang ved første dialyse (DNSL)**

## ValueSet: Dialyseadgang ved første dialyse (DNSL) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/DialyseadgangDNSL | *Version*:1.25.1 |
