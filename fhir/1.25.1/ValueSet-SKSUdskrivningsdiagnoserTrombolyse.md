# SKS: Udskrivningsiagnoser for Trombolyse (DAP) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SKS: Udskrivningsiagnoser for Trombolyse (DAP)**

## ValueSet: SKS: Udskrivningsiagnoser for Trombolyse (DAP) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SKSUdskrivningsdiagnoserTrombolyse | *Version*:1.25.1 |
