# Ventral hernie cicatrice type (DHDB) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Ventral hernie cicatrice type (DHDB)**

## ValueSet: Ventral hernie cicatrice type (DHDB) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/VentralHernieCicatriceTypeDHDB | *Version*:1.25.1 |
  ...
  "compose" : {
    "include" : [{
      ...
      },
      {
        ...
        "display" : "Tværcicatrice Port-hernie"
      }]
    },
    {
