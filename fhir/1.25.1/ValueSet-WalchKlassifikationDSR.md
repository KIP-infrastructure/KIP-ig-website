# Walch klassifikation (DSR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Walch klassifikation (DSR)**

## ValueSet: Walch klassifikation (DSR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/WalchKlassifikationDSR | *Version*:1.25.1 |
