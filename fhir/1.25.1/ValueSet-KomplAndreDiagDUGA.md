# Komplikationer pga. 'Andre' - Diagnosekoder (DUGA) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komplikationer pga. 'Andre' - Diagnosekoder (DUGA)**

## ValueSet: Komplikationer pga. 'Andre' - Diagnosekoder (DUGA) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomplAndreDiagDUGA | *Version*:1.25.1 |
