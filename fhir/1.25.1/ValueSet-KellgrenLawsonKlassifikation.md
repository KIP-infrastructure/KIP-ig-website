# Kellgren-Lawrence Klassifikation (DKR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Kellgren-Lawrence Klassifikation (DKR)**

## ValueSet: Kellgren-Lawrence Klassifikation (DKR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KellgrenLawsonKlassifikation | *Version*:1.25.1 |
