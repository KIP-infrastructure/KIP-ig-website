# Modified Raymond-Roy klassifikation (MRRC) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Modified Raymond-Roy klassifikation (MRRC)**

## ValueSet: Modified Raymond-Roy klassifikation (MRRC) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/ModifiedRaymondRoyKlassification | *Version*:1.25.1 |
