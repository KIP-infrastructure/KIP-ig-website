# Responsevaluering på behandling (LYFO) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Responsevaluering på behandling (LYFO)**

## ValueSet: Responsevaluering på behandling (LYFO) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/BehandlingsResponsEvalueringLYFO | *Version*:1.25.1 |
