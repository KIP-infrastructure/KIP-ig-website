# Patobank SNOMED: pTNM klassifikation, pT - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Patobank SNOMED: pTNM klassifikation, pT**

## ValueSet: Patobank SNOMED: pTNM klassifikation, pT 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/PatobankSNOMEDpTNMpT | *Version*:1.25.1 |
