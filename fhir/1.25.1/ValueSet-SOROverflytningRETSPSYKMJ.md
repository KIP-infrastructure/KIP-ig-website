# SOR: Overflytning Midtjylland (RETSPSYK) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SOR: Overflytning Midtjylland (RETSPSYK)**

## ValueSet: SOR: Overflytning Midtjylland (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SOROverflytningRETSPSYKMJ | *Version*:1.25.1 |
