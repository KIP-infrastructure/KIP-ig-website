# Mors Diagnosekode - Socialt (DNSL) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Mors Diagnosekode - Socialt (DNSL)**

## ValueSet: Mors Diagnosekode - Socialt (DNSL) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/MorsDiagnoseSocialtDNSL | *Version*:1.25.1 |
