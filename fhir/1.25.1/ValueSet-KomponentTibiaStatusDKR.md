# Komponent - tibia, status (DKR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komponent - tibia, status (DKR)**

## ValueSet: Komponent - tibia, status (DKR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomponentTibiaStatusDKR | *Version*:1.25.1 |
