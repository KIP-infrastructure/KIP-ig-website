# Fravalg af antikoagulationsbehandling; årsag - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Fravalg af antikoagulationsbehandling; årsag**

## ValueSet: Fravalg af antikoagulationsbehandling; årsag 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/AKFravalgt | *Version*:1.25.1 |
