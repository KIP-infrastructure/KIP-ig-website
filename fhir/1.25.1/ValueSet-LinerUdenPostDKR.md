# Liner komponent uden Post (DKR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Liner komponent uden Post (DKR)**

## ValueSet: Liner komponent uden Post (DKR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/LinerUdenPostDKR | *Version*:1.25.1 |
