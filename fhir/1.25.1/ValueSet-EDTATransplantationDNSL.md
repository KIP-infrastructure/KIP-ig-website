# EDTA koder Transplantation (DNSL) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EDTA koder Transplantation (DNSL)**

## ValueSet: EDTA koder Transplantation (DNSL) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/EDTATransplantationDNSL | *Version*:1.25.1 |
