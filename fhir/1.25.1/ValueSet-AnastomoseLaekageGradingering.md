# AnastomoseLaekage gradingering - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **AnastomoseLaekage gradingering**

## ValueSet: AnastomoseLaekage gradingering 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/AnastomoseLaekageGradingering | *Version*:1.25.1 |
