# POP-Q undersøgelse Tvl (DUGA) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **POP-Q undersøgelse Tvl (DUGA)**

## ValueSet: POP-Q undersøgelse Tvl (DUGA) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/POPQTvlDUGA | *Version*:1.25.1 |
