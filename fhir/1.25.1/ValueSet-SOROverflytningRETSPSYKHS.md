# SOR: Overflytning Hovedstaden (RETSPSYK) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SOR: Overflytning Hovedstaden (RETSPSYK)**

## ValueSet: SOR: Overflytning Hovedstaden (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SOROverflytningRETSPSYKHS | *Version*:1.25.1 |
