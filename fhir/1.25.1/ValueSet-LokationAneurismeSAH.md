# Anatomisk lokation for anurisme [SAH] - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Anatomisk lokation for anurisme [SAH]**

## ValueSet: Anatomisk lokation for anurisme [SAH] 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/LokationAneurismeSAH | *Version*:1.25.1 |
