# Intraoperative læsioner - Mænd (DCCG) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Intraoperative læsioner - Mænd (DCCG)**

## ValueSet: Intraoperative læsioner - Mænd (DCCG) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/IntraoperativeLaesionerMDCCG | *Version*:1.25.1 |
