# SOR: Overflytning (RETSPSYK) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SOR: Overflytning (RETSPSYK)**

## ValueSet: SOR: Overflytning (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SOROverflytningRETSPSYK | *Version*:1.25.1 |
