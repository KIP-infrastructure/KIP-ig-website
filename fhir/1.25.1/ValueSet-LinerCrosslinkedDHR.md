# Liner - Crosslinked (DHR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Liner - Crosslinked (DHR)**

## ValueSet: Liner - Crosslinked (DHR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/LinerCrosslinkedDHR | *Version*:1.25.1 |
