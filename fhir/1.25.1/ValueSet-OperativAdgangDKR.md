# Operativ adgang (DKR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Operativ adgang (DKR)**

## ValueSet: Operativ adgang (DKR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/OperativAdgangDKR | *Version*:1.25.1 |
