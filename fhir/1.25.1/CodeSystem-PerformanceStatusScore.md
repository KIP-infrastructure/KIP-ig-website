# Performance Status score (ECOG/WHO/Zubrod) - KIP Infrastructure v1.25.1
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/PerformanceStatusScore | *Version*:1.25.1 |
...
* [ECOG Performance Status Scale](ValueSet-ECOG.md)
* [ECOG Performance Status Skala til HÆMA specialerne](ValueSet-ECOGHAEMA.md)
* [WHO Performance status grad 1-4](ValueSet-WHOPerformanceStatus04.md)
