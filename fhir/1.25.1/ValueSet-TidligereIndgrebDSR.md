# Tidligere indgreb (DSR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tidligere indgreb (DSR)**

## ValueSet: Tidligere indgreb (DSR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/TidligereIndgrebDSR | *Version*:1.25.1 |
