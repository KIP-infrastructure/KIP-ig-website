# Hip joint arthroplasty - components - KIP Infrastructure v1.25.1
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/HipJointArthroplastyComponent | *Version*:1.25.1 |
| Active as of 2026-07-31 | *Computable Name*:HipJointArthroplastyComponent |
...
```json
{
  ...
  {
    "code" : "depuy_actis_collared",
    "display" : "DePuy: Actis Collared",
    "definition" : "DePuy: Actis Collared",
    "property" : [{
      "code" : "comment",
      "valueString" : "Added"
    },
    {
      "code" : "effectiveDate",
      "valueDateTime" : "2026-07-31T00:00:00+02:00"
    },
    {
      "code" : "status",
      "valueCode" : "active"
  ...
  {
    "code" : "depuy_corail_cemented",
    "display" : "DePuy: Corail cementeret",
    "definition" : "DePuy: Corail cementeret",
    "property" : [{
      "code" : "comment",
      "valueString" : "Added"
    },
