# Fiksation, Tibia (DKRR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Fiksation, Tibia (DKRR)**

## ValueSet: Fiksation, Tibia (DKRR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/FiksationTibiaDKRR | *Version*:1.25.1 |
