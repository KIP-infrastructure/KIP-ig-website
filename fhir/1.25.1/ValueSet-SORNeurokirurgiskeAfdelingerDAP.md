# SOR: Neurokirurgiske afdelinger (DAP) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SOR: Neurokirurgiske afdelinger (DAP)**

## ValueSet: SOR: Neurokirurgiske afdelinger (DAP) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SORNeurokirurgiskeAfdelingerDAP | *Version*:1.25.1 |
