# Medicin varighed (DSR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Medicin varighed (DSR)**

## ValueSet: Medicin varighed (DSR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/MedicinVarighedDSR | *Version*:1.25.1 |
