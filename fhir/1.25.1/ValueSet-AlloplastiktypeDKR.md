# Alloplastiktype (DKR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Alloplastiktype (DKR)**

## ValueSet: Alloplastiktype (DKR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/AlloplastiktypeDKR | *Version*:1.25.1 |
