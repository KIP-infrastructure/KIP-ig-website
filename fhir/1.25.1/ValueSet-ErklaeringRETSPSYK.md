# Erklæring (RETSPSYK) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Erklæring (RETSPSYK)**

## ValueSet: Erklæring (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/ErklaeringRETSPSYK | *Version*:1.25.1 |
