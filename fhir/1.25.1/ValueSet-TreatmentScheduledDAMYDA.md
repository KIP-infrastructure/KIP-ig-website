# Planlagt behandling (DAMYDA) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Planlagt behandling (DAMYDA)**

## ValueSet: Planlagt behandling (DAMYDA) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/TreatmentScheduledDAMYDA | *Version*:1.25.1 |
