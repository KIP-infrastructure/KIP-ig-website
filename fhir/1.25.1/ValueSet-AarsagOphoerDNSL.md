# Årsag til ophør (DNSL) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Årsag til ophør (DNSL)**

## ValueSet: Årsag til ophør (DNSL) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/AarsagOphoerDNSL | *Version*:1.25.1 |
