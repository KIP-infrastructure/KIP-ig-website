# SOR: Afdelinger Universitetshospitaler (DNSL) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SOR: Afdelinger Universitetshospitaler (DNSL)**

## ValueSet: SOR: Afdelinger Universitetshospitaler (DNSL) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/SORAfdelingerUHDNSL | *Version*:1.25.1 |
