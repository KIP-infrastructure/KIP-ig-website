# Patient respons på behandling (DAMYDA) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Patient respons på behandling (DAMYDA)**

## ValueSet: Patient respons på behandling (DAMYDA) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/TreatmentResponseDAMYDA | *Version*:1.25.1 |
