# Interventionsgruppe Hæmodialyse (DNSL) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Interventionsgruppe Hæmodialyse (DNSL)**

## ValueSet: Interventionsgruppe Hæmodialyse (DNSL) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/InterventionsgruppeDialyseHaemoDNSL | *Version*:1.25.1 |
