# Behandlingsindikation (KAR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Behandlingsindikation (KAR)**

## ValueSet: Behandlingsindikation (KAR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/BehandlingsindikationKAR | *Version*:1.25.1 |
