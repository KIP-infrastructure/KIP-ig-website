# Risikovurdering (RETSPSYK) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Risikovurdering (RETSPSYK)**

## ValueSet: Risikovurdering (RETSPSYK) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/RisikovurderingRETSPSYK | *Version*:1.25.1 |
