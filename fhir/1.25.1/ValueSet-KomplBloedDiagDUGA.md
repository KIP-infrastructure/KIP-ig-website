# Komplikationer pga. blødning - Diagnosekoder (DUGA) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komplikationer pga. blødning - Diagnosekoder (DUGA)**

## ValueSet: Komplikationer pga. blødning - Diagnosekoder (DUGA) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomplBloedDiagDUGA | *Version*:1.25.1 |
