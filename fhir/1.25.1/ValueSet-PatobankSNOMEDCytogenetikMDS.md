# PatobankSNOMED koder for cytogenetik - recurrente forandringer (MDS) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PatobankSNOMED koder for cytogenetik - recurrente forandringer (MDS)**

## ValueSet: PatobankSNOMED koder for cytogenetik - recurrente forandringer (MDS) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/PatobankSNOMEDCytogenetikMDS | *Version*:1.25.1 |
