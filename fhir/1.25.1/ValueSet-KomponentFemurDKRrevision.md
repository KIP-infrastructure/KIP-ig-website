# Komponent - femur (DKR) revision - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komponent - femur (DKR) revision**

## ValueSet: Komponent - femur (DKR) revision 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomponentFemurDKRrevision | *Version*:1.25.1 |
