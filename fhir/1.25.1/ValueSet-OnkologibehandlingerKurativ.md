# Onkologibehandlinger (kurativ) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Onkologibehandlinger (kurativ)**

## ValueSet: Onkologibehandlinger (kurativ) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/OnkologibehandlingerKurativ | *Version*:1.25.1 |
