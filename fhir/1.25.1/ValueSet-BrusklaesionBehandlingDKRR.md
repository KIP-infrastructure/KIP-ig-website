# Brusklæsion, behandling (DKRR) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Brusklæsion, behandling (DKRR)**

## ValueSet: Brusklæsion, behandling (DKRR) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/BrusklaesionBehandlingDKRR | *Version*:1.25.1 |
