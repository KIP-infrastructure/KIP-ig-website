# Indgreb, åben mesh - ingvinalhernie (DHDB) - KIP Infrastructure v1.25.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Indgreb, åben mesh - ingvinalhernie (DHDB)**

## ValueSet: Indgreb, åben mesh - ingvinalhernie (DHDB) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/IndgrebAabenMeshIngvinalhernieDHDB | *Version*:1.25.1 |
