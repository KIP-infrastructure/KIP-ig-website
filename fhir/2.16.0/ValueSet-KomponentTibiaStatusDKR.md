# Komponent - tibia, status (DKR) - KIP Infrastructure v2.16.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Komponent - tibia, status (DKR)**

## ValueSet: Komponent - tibia, status (DKR) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KomponentTibiaStatusDKR | *Version*:2.16.0 |
| Active as of 2022-10-13 | *Computable Name*:KomponentTibiaStatusDKR |
