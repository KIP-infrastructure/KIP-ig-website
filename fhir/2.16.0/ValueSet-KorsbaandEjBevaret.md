# Korsbånd ikke bevaret - KIP Infrastructure v2.16.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Korsbånd ikke bevaret**

## ValueSet: Korsbånd ikke bevaret (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/KorsbaandEjBevaret | *Version*:2.16.0 |
...
```json
{
  ...
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/KorsbaandEjBevaret",
  "version" : "2.16.0",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://kip.rkkp.dk/fhir/CodeSystem/KorsbaandEjBevaret",
        "concept" : [
          {
            "code" : "ofret",
