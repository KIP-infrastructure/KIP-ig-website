# Anatomy locations, not specified in classifcations (SKS, etc.) - KIP Infrastructure v2.16.0
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/AnatomicalLocations | *Version*:2.16.0 |
