# Operationskode - Urin-inkontinens og genital prolaps (DUGA) - KIP Infrastructure v2.16.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Operationskode - Urin-inkontinens og genital prolaps (DUGA)**

## ValueSet: Operationskode - Urin-inkontinens og genital prolaps (DUGA) (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/ValueSet/OpkodeUrinGenitalDUGA | *Version*:2.16.0 |
| Active as of 2024-02-14 | *Computable Name*:OpkodeUrinGenitalDUGA |
...
```json
{
  ...
  "id" : "OpkodeUrinGenitalDUGA",
  "url" : "https://kip.rkkp.dk/fhir/ValueSet/OpkodeUrinGenitalDUGA",
  "version" : "2.16.0",
  "name" : "OpkodeUrinGenitalDUGA",
