# EDTA koder (DNSL) - KIP Infrastructure v2.13.0
...
| | |
| :--- | :--- |
| *Official URL*:https://kip.rkkp.dk/fhir/CodeSystem/EDTACodes | *Version*:2.13.0 |
...
```json
{
  ...
  "concept" : [
    ...
    {
      "code" : "EDTA74",
      "display" : "EDTA74, Grafttab, reccurent primær leverlidelse",
      "definition" : "EDTA74, Grafttab, reccurent primær leverlidelse"
    },
    {
      "code" : "EDTA75",
